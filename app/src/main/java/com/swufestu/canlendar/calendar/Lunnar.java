...
public class Lunnar {
    ...
    final static String Number[]={ "一", "二", "三", "四", "五", "六", "七",
            "八", "九", "十", "十一", "十二" };
   ...
   final private static int leapmonth(int y) {
    ...
    public static String getChinaDayString(int day) {
        ...
        if (day == 10)
            ...
            return chineseTen[day / 10] + Number[n];
    }
    public String getLunarDate(int year_log, int month_log, int day_log, boolean isday) {
        ...
        month = iMonth;
        setLunarmonth(Number[month - 1] + "月");  //设置对应的阴历月份
        day = offset + 1;
    ...
    public String toString() {
        if (Number[month - 1] == "一" && getChinaDayString(day) == "初一")
            return "农历" + year + "年";
